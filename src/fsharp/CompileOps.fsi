...
val GetTranslators: ITranslator list -> ITranslator<ICompilerConfig, ErrorLogger, 'Node> list

// Apply translators to ASTs
val ApplyTranslators: TcConfig * ITranslator<ICompilerConfig, ErrorLogger, 'Node> list * ErrorLogger * 'Node -> 'Node
